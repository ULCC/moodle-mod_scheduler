...
$string['alreadyonwaitinglist'] =   'You are already on the waiting list';
...
$string['bookingrestrictionmsg']            =   'Booking Restricted <p> You are unable to make this booking as you have reached the maximum number of bookings allowed in a {$a} period</p>';
...
$string['clearwaitinglistonunhidden']   =   'Clear waiting list when hidden slot is displayed ';
$string['clearwaitinglistonunhidden_help']   =   'Clears the waiting list of a scheduler when a hidden slot is displayed ';
...
$string['declinedwaitinglist']  =   'You have been removed from the waiting list';
$string['declinewaitingslot']   =   'Remove me from the list';
...
$string['never'] = 'Never';
$string['newwaitinglistentry']              =       'A user has joined the waiting list for the {$a} scheduler ';
$string['newwaitinglistentrybody']          =       '<p>A user has joined the waiting list for {$a->schedulername}</p>
<br><br>If you want to add more slots to the scheduler <a href="{$a->addslot}">Click here ({$a->addslot})</a>';
$string['newwaitinglistentrybodyhtml']      =       '<p>A user has joined the waiting list for {$a->schedulername}</p>
<br><br>If you want to add more slots to the scheduler <a href="{$a->addslot}">Click here ({$a->addslot})</a>';
...
$string['relativetime'] =   'Relative time';
$string['reminder'] = 'Reminder';
$string['removewaitinglistentry']   =   'Remove from waiting list';
$string['removedfromwaitinglist']   =   'You have been removed from the waiting list';
...
$string['threedaysbefore']  =   'Three days before';
...
$string['twodaysbefore']    =   'Two days before';
...
$string['waitingremovedbysystem']    =   'Removed by system';
$string['waitingremovedbyadmin']    =   'Removed by admin';
$string['waitinglistentrynotification']     =   'Send notification when user joins waiting list';
$string['waitinglistentrynotification_help']     =   'Should a notification be sent to the user who created the waiting list when a student joins the waiting list';
