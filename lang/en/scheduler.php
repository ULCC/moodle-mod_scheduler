...
$string['visitaccepturl']   =   'Visit this following url to make a booking: {$a}';
$string['visitdeclineurl']   =   'Visit this following url to remove yourself from the waiting list: {$a}';
